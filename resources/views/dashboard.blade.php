...
<li>
<a class="CHATBOX_open" href="#"> <img src = "{{ asset( 'backend/img/icon/msg.svg ' ) }}" alt> <span>01</span> </a>
</li>
</div>
...
<script src = "{{ asset( 'backend/vendors/apex_chart/apex_realestate.js ' ) }}"></script>
