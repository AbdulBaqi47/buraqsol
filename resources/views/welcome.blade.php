...
<link href="{{ asset( 'frontend/assets/css/meanmenu.min.css') }}" rel="stylesheet">
...
<div class="page-wrapper">
	...
	<header class="main-header header-style-one">
			...
			<div class="auto-container">
				<div class="inner-container">
					<div class="d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="logo-box">
							<div class="logo"><a href="index-2.html"><img src="{{ asset( 'frontend/assets/images/logo.svg' ) }}" alt="" title=""></a></div>
						</div>
						...
						<div class="outer-box d-flex align-items-center flex-wrap">
							...
							<div class="language-dropdown">
								<button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
									<span class="flag"><img src="{{ asset( 'frontend/assets/images/icons/flag.png' ) }}" alt="" /></span> <span class="fa-solid fa-angle-down fa-fw"></span>
								</button>
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
									<li><a class="dropdown-item" href="#"><span class="flag"><img src="{{ asset( 'frontend/assets/images/icons/flag.png' ) }}" alt="" /></span> English</a></li>
									<li><a class="dropdown-item" href="#"><span class="flag"><img src="{{ asset( 'frontend/assets/images/icons/arabic.png' ) }}" alt="" /></span> Arbic</a></li>
									<li><a class="dropdown-item" href="#"><span class="flag"><img src="{{ asset( 'frontend/assets/images/icons/germany.png' ) }}" alt="" /></span> German</a></li>
									<li><a class="dropdown-item" href="#"><span class="flag"><img src="{{ asset( 'frontend/assets/images/icons/france.png' ) }}" alt="" /></span> French</a></li>
								</ul>
							</div>
		...
		<div class="mobile-menu">
			...
			<nav class="menu-box">
				<div class="nav-logo"><a href="index-2.html"><img src="{{ asset( 'frontend/assets/images/mobile-logo.svg' ) }}" alt="" title=""></a></div>
		...
		<div class="main-slider swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<div class="slider-one_icon" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/icon-1.png' ) }})"></div>
					<div class="slider-one_icon-two" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/icon-1.png' ) }})"></div>
					<div class="slider-one_pattern" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/pattern-1.png' ) }})"></div>
					<div class="slider-one_pattern-two" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/pattern-2.png' ) }})"></div>
					<div class="slider-one_pattern-four" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/pattern-4.png' ) }})"></div>
					<div class="auto-container">
						<div class="row clearfix">
							<!-- Content Column -->
							<div class="slider-one_content col-lg-7 col-md-12 col-sm-12">
								<div class="slider-one_content-inner">
									<div class="slider-one_title"><i><img src="{{ asset( 'frontend/assets/images/main-slider/hand.png' ) }}" alt="" /></i> AI makes content fast & easy</div>
							...
							<div class="slider-one_image-column col-lg-5 col-md-12 col-sm-12">
								<div class="slider-one_pattern-three" style="background-image:url({{ asset( 'frontend/assets/images/main-slider/pattern-3.png' ) }})"></div>
								<div class="slider-one_image-outer">
									<!-- Slider One Author -->
									<div class="slider-one_author">
										<i><img src="{{ asset( 'frontend/assets/images/main-slider/icon-2.png' ) }}" alt="" /></i>
									...
									<div class="slider-one_graph">
										...
										<img src="{{ asset( 'frontend/assets/images/main-slider/graph.png' ) }}" alt="" />
									</div>
			...
			<div class="row clearfix">
				...
				<div class="service-block_two col-lg-4 col-md-6 col-sm-12">
					<div class="service-block_two-inner wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="service-block_two-sideicon" style="background-image:url({{ asset( 'frontend/assets/images/icons/service-1.png' ) }})"></div>
						<div class="service-block_two-icon">
							<img src="{{ asset( 'frontend/assets/images/icons/service.png' ) }}" alt="" />
						</div>
	...
	<section class="about-one">
		<div class="about-one_pattern" style="background-image:url({{ asset( 'frontend/assets/images/background/about-pattern.png' ) }})"></div>
		<div class="about-one_icon" style="background-image:url({{ asset( 'frontend/assets/images/icons/about-1.png' ) }})"></div>
		<div class="about-one_icon-two" style="background-image:url({{ asset( 'frontend/assets/images/icons/about-2.png' ) }})"></div>
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="about-one_tab-column col-xl-6 col-lg-6 col-md-12 col-sm-12">
					<div class="about-one_tab-outer">
						<div class="about-one_tab-shadow" style="background-image:url({{ asset( 'frontend/assets/images/background/tab-shadow.png' ) }})"></div>
						<div class="about-one_tab-image">
							<img src="{{ asset( 'frontend/assets/images/resource/tabs.png' ) }}" alt="" />
						</div>
					</div>
				</div>
			...
			<div class="row clearfix">
				...
				<div class="answer-one_content-column col-lg-7 col-md-12 col-sm-12">
					<div class="answer-one_content-outer">
						<div class="answer-one_pattern" style="background-image:url({{ asset( 'frontend/assets/images/background/faq-shadow.png' ) }})"></div>
						<div class="answer-one_image">
							<img src="{{ asset( 'frontend/assets/images/resource/faq.png' ) }}" alt="" />
						</div>
					</div>
				</div>
	...
	<section class="testimonial-one">
		<div class="auto-container">
			<div class="inner-container" style="background-image:url({{ asset( 'frontend/assets/images/background/testimonial-one_bg.png' ) }})">
				<!-- Sec Title -->
				<div class="sec-title centered">
						...
						<div class="swiper-slide">
							...
							<div class="testimonial-block_one">
								<div class="testimonial-block_one-inner">
									...
									<div class="testimonial-block_one-author_box">
										<div class="testimonial-block_one-author-image">
											<img src="{{ asset( 'frontend/assets/images/resource/author-4.png' ) }}" alt="" />
										</div>
	...
	<section class="steps-one">
		<div class="steps-one_bg" style="background-image:url({{ asset( 'frontend/assets/images/background/step-1_bg.png' ) }})"></div>
		<div class="steps-one_icon" style="background-image:url({{ asset( 'frontend/assets/images/icons/step.png' ) }})"></div>
		<div class="auto-container">
			<div class="inner-container">
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{ asset( 'frontend/assets/images/resource/step-1.png' ) }}" alt="" />
									</div>
								</div>
							</div>
						</div>
					...
					<div class="column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{ asset( 'frontend/assets/images/resource/step-2.png' ) }}" alt="" />
									</div>
								</div>
							</div>
						</div>
						...
						<div class="step-block_one">
							<div class="step-block_one-inner">
								...
								<div class="step-block_one-content">
									<div class="image">
										<img src="{{ asset( 'frontend/assets/images/resource/step-3.png' ) }}" alt="" />
									</div>
								</div>
							</div>
						</div>
	...
	<section class="price-one">
		<div class="price-one_bg" style="background-image:url({{ asset( 'frontend/assets/images/background/price-bg.png' ) }})"></div>
		<div class="auto-container">
			<div class="inner-container">
				<!-- Sec Title -->
							...
							<div class="content">
								<div class="row clearfix">
									...
									<div class="price-block_one active col-lg-4 col-md-6 col-sm-12">
										<div class="price-block_one-inner">
											<div class="price-one_stars" style="background-image:url({{ asset( 'frontend/assets/images/icons/price-stars.png' ) }})"></div>
	...
	<section class="faq-one">
		<div class="faq-one_bg" style="background-image:url({{ asset( 'frontend/assets/images/background/faq-bg.png' ) }})"></div>
		<div class="faq-one_icon" style="background-image:url({{ asset( 'frontend/assets/images/icons/step.png' ) }})"></div>
		<div class="auto-container">
			<div class="row clearfix">
	...
	<section class="social-one">
		<div class="social-one_bg-shadow" style="background-image:url({{ asset( 'frontend/assets/images/background/social-bg.png' ) }})"></div>
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
			...
			<div class="social-one_logo">
				<span><img src="{{ asset( 'frontend/assets/images/icons/social-logo.png' ) }}" alt="" /></span>
			</div>
			<div class="inner-container">
				<div class="social-one_bg" style="background-image:url({{ asset( 'frontend/assets/images/background/social-one_pattern.png' ) }})"></div>
				<div class="social-one_bg-two" style="background-image:url({{ asset( 'frontend/assets/images/background/social-one_pattern-two.png' ) }})"></div>
				...
				<div class="social-box_one">
					<div class="animation_mode">
						...
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-1.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-2.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-3.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-4.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-5.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-6.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-7.png' ) }}" alt="" />
							</a>
						</div>
					</div>
				</div>
				...
				<div class="social-box">
					<div class="animation_mode_two">
						...
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-8.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-9.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-10.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-11.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-12.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-13.png' ) }}" alt="" />
							</a>
						</div>
						<!-- Icon -->
						<div class="social_icon-box">
							<a href="#">
								<img src="{{ asset( 'frontend/assets/images/icons/social-14.png' ) }}" alt="" />
							</a>
						</div>
					</div>
				</div>
	...
	<section class="news-one">
		<div class="news-one_shadow" style="background-image:url({{ asset( 'frontend/assets/images/background/news-shadow-1.png' ) }})"></div>
		<div class="news-one_shadow-two" style="background-image:url({{ asset( 'frontend/assets/images/background/news-shadow-2.png' ) }})"></div>
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title title-anim centered">
	...
	<section class="cta-one">
		<div class="auto-container">
			<div class="inner-container">
				<div class="cta-icon_one" style="background-image:url({{ asset( 'frontend/assets/images/icons/cta-icon-1.png' ) }})"></div>
				<div class="cta-icon_two" style="background-image:url({{ asset( 'frontend/assets/images/icons/cta-icon-2.png' ) }})"></div>
				<div class="cta-one_card">
					<img src="{{ asset( 'frontend/assets/images/icons/cta-card.png' ) }}" alt="" />
				</div>
				<div class="row clearfix">
					<!-- Column -->
					...
					<div class="cta-one_image-column col-lg-6 col-md-12 col-sm-12">
						<div class="cta-one_image-outer">
							<div class="cta-one_cards">
								<img src="{{ asset( 'frontend/assets/images/icons/cta-cards.png' ) }}" alt="" />
							</div>
							<div class="image">
								<img src="{{ asset( 'frontend/assets/images/resource/cta.png' ) }}" alt="" />
							</div>
						</div>
					</div>
				</div>
	...
	<footer class="main-footer">
		<div class="footer_pattern" style="background-image: url({{ asset( 'frontend/assets/images/background/footer-pattern.png' ) }})"></div>
		<div class="auto-container">
			<div class="inner-container">
				<!-- Widgets Section -->
						...
						<div class="big-column col-lg-5 col-md-12 col-sm-12">
							<div class="footer-newsletter">
								...
								<div class="newsletter-box">
									<form method="post" action="https://demo.themeim.com/html/braine/contact.html">
		...
		<div class="footer-bottom">
			<div class="auto-container">
				<div class="inner-container d-flex justify-content-between align-items-center flex-wrap">
					<div class="footer-logo"><a href="index-2.html"><img src="{{ asset( 'frontend/assets/images/logo.svg' ) }}" alt="" title=""></a></div>
					<div class="footer-copyright">&copy; 2024 <a href="index-2.html">Braine.</a> All rights reserved.</div>
					<!-- Social Box -->
...
<!-- Mirrored from demo.themeim.com/html/braine/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Mar 2024 05:30:36 GMT -->
</html>
